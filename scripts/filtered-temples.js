...
const temples = [
    ...
    {
        templeName: "Ceder City Utah",
        location: "Ceder City, Utah",
    ...
    },
    {
        ...
        area: 45800,
        imageUrl: "https://content.churchofjesuschrist.org/templesldsorg/bc/Temples/photo-galleries/madrid-spain/400x250/madrid-spain-mormon-temple-1075586-wallpaper.jpg"
    }
];
...
oldTemplesLink.addEventListener("click", () => {
    let old = temples.filter(temple => temple.dedicated.includes("19"));
    createTempleCard(old);
});

newTemplesLink.addEventListener("click", () => {
    let newt = temples.filter(temple => temple.dedicated.includes("20"));
